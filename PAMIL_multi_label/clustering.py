...
parser.add_argument('--model_type', type=str, choices=['wsod', 'wsod_nic','wsod_nic_single','nicwss','clam_sb', 'clam_mb', 'pmil', 'opmil'], 
                    default='wsod_nic', 
...
def main(args):
    ...
    for cur in folds:
        ...
        cluster_centers = []
        with torch.no_grad():
            for batch_idx, (data, label, cors, inst_label, _) in enumerate(train_loader):
                data_np = data.numpy()
